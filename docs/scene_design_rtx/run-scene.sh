...
cd "$TASK_ROOT/steerable"
export PYTHONPATH="$TASK_ROOT/steerable:$TASK_ROOT/RoboLab" PYTHONNOUSERSITE=1 PYTHONUNBUFFERED=1
...
exec "$TASK_ROOT/venv/bin/python" -m experiments.workshops.spatial_grounding_v1.scene_design_runner \
