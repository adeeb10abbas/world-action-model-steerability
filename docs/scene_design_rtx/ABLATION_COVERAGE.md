...
2. **Qualify both model interfaces and recording.** Verify resets, actual model inputs, decoded futures, action prefixes and physical time maps for N3, E3 and F3. The pilot validates measurement; development fixes H and analysis choices before confirmation.
